  ...
  it('creates a pact to verify multipart form with JPG image upload', async () => {
    ...
    await pact
      ...
      .executeTest(async (mockServer) => {
        ...
        expect(response.data.filename).toBeTypeOf('string');
  ...
  it('creates a pact using withRequestMultipartFileUpload helper method', async () => {
    ...
    await pact
      ...
      .executeTest(async (mockServer) => {
        ...
        // Verify the response
        expect(response.data.success).toBe(true);
        expect(response.data.filename).toBe('test-upload-file.txt');
        expect(response.data.message).toBe('File received successfully');
      });
  });
  ...
  it('creates a pact using withRequestMultipartFileUpload with custom boundary', async () => {
    ...
    await pact
      ...
      .executeTest(async (mockServer) => {
        ...
        expect(response.data.boundary).toBe(customBoundary);
      });
  });
